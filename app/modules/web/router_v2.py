"""
AZALS MODULE WEB - Router v2 CORE SaaS
=====================================
...
async def create_theme(
    ...
    **Permissions requises:** web.themes.create
    """
...
async def list_themes(
    ...
    **Permissions requises:** web.themes.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def update_theme(
    ...
    **Permissions requises:** web.themes.update
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def delete_theme(
    ...
    **Permissions requises:** web.themes.delete
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_widget(
    ...
    **Permissions requises:** web.widgets.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_widgets(
    ...
    **Permissions requises:** web.widgets.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def update_widget(
    ...
    **Permissions requises:** web.widgets.update
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def delete_widget(
    ...
    **Permissions requises:** web.widgets.delete
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_dashboard(
    ...
    **Permissions requises:** web.dashboards.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_dashboards(
    ...
    **Permissions requises:** web.dashboards.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def update_dashboard(
    ...
    **Permissions requises:** web.dashboards.update
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def delete_dashboard(
    ...
    **Permissions requises:** web.dashboards.delete
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_menu_item(
    ...
    **Permissions requises:** web.menu.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_menu_items(
    ...
    **Permissions requises:** web.menu.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def update_menu_item(
    ...
    **Permissions requises:** web.menu.update
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def delete_menu_item(
    ...
    **Permissions requises:** web.menu.delete
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def get_user_preferences(
    ...
    **Permissions requises:** web.preferences.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def update_user_preferences(
    ...
    **Permissions requises:** web.preferences.update
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def get_ui_config(
    ...
    **Permissions requises:** web.config.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_shortcut(
    ...
    **Permissions requises:** web.shortcuts.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_user_shortcuts(
    ...
    **Permissions requises:** web.shortcuts.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_page(
    ...
    **Permissions requises:** web.pages.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_pages(
    ...
    **Permissions requises:** web.pages.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def publish_page(
    ...
    **Permissions requises:** web.pages.publish
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def create_component(
    ...
    **Permissions requises:** web.components.create
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
...
async def list_components(
    ...
    **Permissions requises:** web.components.read
    """
    service = get_web_service(db, context.tenant_id, context.user_id)
