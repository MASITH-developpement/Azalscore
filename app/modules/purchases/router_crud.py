"""
AZALS MODULE - PURCHASES: Router Unifié
========================================
...
Enregistrement dans main.py:
    from app.modules.purchases.router_unified import router as purchases_router

    # Double enregistrement pour compatibilité
    app.include_router(purchases_router, prefix="/v2")
    app.include_router(purchases_router, prefix="/v1", deprecated=True)

Conformité : AZA-NF-006

ENDPOINTS (19 total):
- Suppliers (5): CRUD + soft delete
- Orders (7): CRUD + validate/cancel + delete
- Invoices (6): CRUD + validate + delete
- Summary (1): dashboard
"""
...
router = APIRouter(prefix="/purchases", tags=["Purchases - Achats"])
