"""
AZALS MODULE T5 - Router v2 Packs Pays - CORE SaaS
===================================================
API pour la gestion des configurations pays avec SaaSContext.
"""
...
router = APIRouter(prefix="/v2/country-packs", tags=["Country Packs v2 - CORE SaaS"])
