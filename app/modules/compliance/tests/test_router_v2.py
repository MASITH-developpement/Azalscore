...
class TestRegulations:
    ...
    def test_create_regulation_success(self, client, mock_saas_context, regulation_data, regulation_id):
...
class TestWorkflows:
    ...
    def test_assessment_to_remediation_workflow(self, client, mock_saas_context,
    ...
    def test_audit_to_findings_workflow(self, client, mock_saas_context,
