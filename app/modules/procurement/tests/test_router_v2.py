...
def test_create_supplier(client, auth_headers, supplier_data, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/suppliers", json=supplier_data, headers=auth_headers)
...
def test_create_supplier_duplicate_code(client, auth_headers, supplier_data, sample_supplier):
...
def test_list_suppliers(client, auth_headers, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/suppliers", headers=auth_headers)
...
def test_get_supplier(client, auth_headers, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get(f"/v2/procurement/suppliers/{supplier_id}", headers=auth_headers)
...
def test_update_supplier(client, auth_headers, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.put(f"/v2/procurement/suppliers/{supplier_id}", json=update_data, headers=auth_headers)
...
def test_approve_supplier(client, auth_headers, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/suppliers/{supplier_id}/approve", headers=auth_headers)
...
def test_add_supplier_contact(client, auth_headers, sample_supplier):
...
def test_list_supplier_contacts(client, auth_headers, sample_supplier):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get(f"/v2/procurement/suppliers/{supplier_id}/contacts", headers=auth_headers)
...
def test_supplier_inactive_filter(client, auth_headers):
...
def test_create_requisition(client, auth_headers, requisition_data, sample_requisition):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/requisitions", json=requisition_data, headers=auth_headers)
...
def test_list_requisitions(client, auth_headers, sample_requisition):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/requisitions", headers=auth_headers)
...
def test_get_requisition(client, auth_headers, sample_requisition):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get(f"/v2/procurement/requisitions/{requisition_id}", headers=auth_headers)
...
def test_get_requisition_not_found(client, auth_headers):
...
def test_submit_requisition(client, auth_headers, sample_requisition):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/requisitions/{requisition_id}/submit", headers=auth_headers)
...
def test_approve_requisition(client, auth_headers, sample_requisition, user_id):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/requisitions/{requisition_id}/approve", headers=auth_headers)
...
def test_reject_requisition(client, auth_headers, sample_requisition, user_id):
...
def test_requisition_workflow(client, auth_headers, requisition_data, sample_requisition):
...
def test_requisition_pagination(client, auth_headers, sample_requisition):
...
def test_requisition_status_filter(client, auth_headers, sample_requisition):
...
def test_create_order(client, auth_headers, order_data, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/orders", json=order_data, headers=auth_headers)
...
def test_list_orders(client, auth_headers, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/orders", headers=auth_headers)
...
def test_list_orders_with_filters(client, auth_headers, sample_order, sample_supplier):
...
def test_get_order(client, auth_headers, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get(f"/v2/procurement/orders/{order_id}", headers=auth_headers)
...
def test_update_order(client, auth_headers, sample_order, order_data):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.put(f"/v2/procurement/orders/{order_id}", json=order_data, headers=auth_headers)

        assert response.status_code == 200


def test_delete_order(client, auth_headers, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.delete(f"/v2/procurement/orders/{order_id}", headers=auth_headers)

        assert response.status_code == 204


def test_send_order(client, auth_headers, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/orders/{order_id}/send", headers=auth_headers)
...
def test_confirm_order(client, auth_headers, sample_order):
...
def test_validate_order(client, auth_headers, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/orders/{order_id}/validate", headers=auth_headers)

        assert response.status_code == 200


def test_create_invoice_from_order(client, auth_headers, sample_order, sample_invoice):
...
def test_export_orders_csv(client, auth_headers):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/orders/export/csv", headers=auth_headers)
...
def test_order_workflow(client, auth_headers, order_data, sample_order):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/orders/{order_id}/confirm", headers=auth_headers)
        assert response.status_code == 200


def test_delete_order_sent(client, auth_headers, sample_order):
...
def test_create_receipt(client, auth_headers, receipt_data, sample_receipt):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/receipts", json=receipt_data, headers=auth_headers)
...
def test_list_receipts(client, auth_headers, sample_receipt):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/receipts", headers=auth_headers)
...
def test_validate_receipt(client, auth_headers, sample_receipt):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/receipts/{receipt_id}/validate", headers=auth_headers)
...
def test_receipt_pagination(client, auth_headers, sample_receipt):
...
def test_receipt_linked_to_order(client, auth_headers, sample_receipt, sample_order):
...
def test_receipt_validation_updates_order(client, auth_headers, sample_receipt):
...
def test_create_invoice(client, auth_headers, invoice_data, sample_invoice):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/invoices", json=invoice_data, headers=auth_headers)
...
def test_list_invoices(client, auth_headers, sample_invoice):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/invoices", headers=auth_headers)
...
def test_list_invoices_with_filters(client, auth_headers, sample_invoice, sample_supplier):
...
def test_get_invoice(client, auth_headers, sample_invoice):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get(f"/v2/procurement/invoices/{invoice_id}", headers=auth_headers)
...
def test_update_invoice(client, auth_headers, sample_invoice, invoice_data):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.put(f"/v2/procurement/invoices/{invoice_id}", json=invoice_data, headers=auth_headers)

        assert response.status_code == 200


def test_delete_invoice(client, auth_headers, sample_invoice):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.delete(f"/v2/procurement/invoices/{invoice_id}", headers=auth_headers)
...
def test_validate_invoice(client, auth_headers, sample_invoice):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post(f"/v2/procurement/invoices/{invoice_id}/validate", headers=auth_headers)
...
def test_export_invoices_csv(client, auth_headers):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/invoices/export/csv", headers=auth_headers)
...
def test_delete_invoice_validated(client, auth_headers, sample_invoice):
...
def test_create_payment(client, auth_headers, payment_data, sample_payment):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/payments", json=payment_data, headers=auth_headers)
...
def test_payment_allocation(client, auth_headers, payment_data, sample_payment):
...
def test_payment_reduces_invoice_balance(client, auth_headers, payment_data, sample_payment):
...
def test_create_evaluation(client, auth_headers, evaluation_data, sample_evaluation):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.post("/v2/procurement/evaluations", json=evaluation_data, headers=auth_headers)
...
def test_evaluation_scores(client, auth_headers, evaluation_data, sample_evaluation):
...
def test_get_dashboard(client, auth_headers, sample_dashboard):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        response = client.get("/v2/procurement/dashboard", headers=auth_headers)
...
def test_dashboard_structure(client, auth_headers, sample_dashboard):
...
def test_complete_procurement_cycle(
    client, auth_headers, requisition_data, order_data, receipt_data,
...
def test_order_to_invoice_workflow(
    client, auth_headers, order_data, sample_order, sample_invoice
):
    ...
    with patch("app.modules.procurement.router_v2.get_procurement_service") as mock_service:
        ...
        service_instance.create_invoice_from_order.return_value = sample_invoice
        response = client.post(f"/v2/procurement/orders/{order_id}/create-invoice", headers=auth_headers)
        assert response.status_code == 201
...
def test_tenant_isolation(client, auth_headers, supplier_data, sample_supplier):
...
def test_context_propagation(client, auth_headers, order_data, sample_order):
