"""
AZALS MODULE PRODUCTION - Router API v2 (CORE SaaS)
====================================================
...
router = APIRouter(prefix="/v2/production", tags=["M6 - Production"])
...
def get_service_v2(
    ...
    return get_production_service(db, context.tenant_id)
...
async def create_work_center(
    ...
    """✅ MIGRÉ CORE SaaS: Créer un centre de travail"""
...
async def get_work_center(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer un centre de travail"""
    service = get_production_service(db, context.tenant_id)
...
async def update_work_center(
    ...
    """✅ MIGRÉ CORE SaaS: Mettre à jour un centre de travail"""
    service = get_production_service(db, context.tenant_id)
...
async def set_work_center_status(
    ...
    """✅ MIGRÉ CORE SaaS: Modifier le statut d'un centre de travail"""
    service = get_production_service(db, context.tenant_id)
    return service.set_work_center_status(wc_id, status, context.user_id)
...
async def get_work_center_orders(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les ordres de travail d'un centre"""
    service = get_production_service(db, context.tenant_id)
...
async def create_bom(
    ...
    """✅ MIGRÉ CORE SaaS: Créer une nomenclature"""
    service = get_production_service(db, context.tenant_id)
...
async def list_boms(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les nomenclatures"""
    service = get_production_service(db, context.tenant_id)
...
async def get_bom(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer une nomenclature"""
    service = get_production_service(db, context.tenant_id)
...
async def get_bom_by_product(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer la nomenclature active d'un produit"""
    service = get_production_service(db, context.tenant_id)
...
async def update_bom(
    ...
    """✅ MIGRÉ CORE SaaS: Mettre à jour une nomenclature"""
    service = get_production_service(db, context.tenant_id)
...
async def activate_bom(
    ...
    """✅ MIGRÉ CORE SaaS: Activer une nomenclature"""
    service = get_production_service(db, context.tenant_id)
...
async def add_bom_line(
    ...
    """✅ MIGRÉ CORE SaaS: Ajouter une ligne à une nomenclature"""
    service = get_production_service(db, context.tenant_id)
...
async def create_routing(
    ...
    """✅ MIGRÉ CORE SaaS: Créer une gamme de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def list_routings(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les gammes"""
    service = get_production_service(db, context.tenant_id)
...
async def get_routing(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer une gamme"""
    service = get_production_service(db, context.tenant_id)
...
async def create_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Créer un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def list_manufacturing_orders(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les ordres de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def get_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def update_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Mettre à jour un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def confirm_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Confirmer un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def start_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Démarrer un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def complete_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Terminer un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def cancel_manufacturing_order(
    ...
    """✅ MIGRÉ CORE SaaS: Annuler un ordre de fabrication"""
    service = get_production_service(db, context.tenant_id)
...
async def pause_work_order(
    ...
    """✅ MIGRÉ CORE SaaS: Mettre en pause un ordre de travail"""
    service = get_production_service(db, context.tenant_id)
...
async def resume_work_order(
    ...
    """✅ MIGRÉ CORE SaaS: Reprendre un ordre de travail"""
    service = get_production_service(db, context.tenant_id)
...
async def consume_material(
    ...
    """✅ MIGRÉ CORE SaaS: Consommer des matières premières"""
    service = get_production_service(db, context.tenant_id)
...
async def return_material(
    ...
    """✅ MIGRÉ CORE SaaS: Retourner des matières au stock"""
    service = get_production_service(db, context.tenant_id)
...
async def record_production(
    ...
    """✅ MIGRÉ CORE SaaS: Enregistrer une production"""
    service = get_production_service(db, context.tenant_id)
...
async def record_scrap(
    ...
    """✅ MIGRÉ CORE SaaS: Enregistrer un rebut"""
    service = get_production_service(db, context.tenant_id)
...
async def list_scraps(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les rebuts"""
    service = get_production_service(db, context.tenant_id)
...
async def create_production_plan(
    ...
    """✅ MIGRÉ CORE SaaS: Créer un plan de production"""
    service = get_production_service(db, context.tenant_id)
...
async def get_production_plan(
    ...
    """✅ MIGRÉ CORE SaaS: Récupérer un plan de production"""
    service = get_production_service(db, context.tenant_id)
...
async def schedule_maintenance(
    ...
    """✅ MIGRÉ CORE SaaS: Planifier une maintenance"""
    service = get_production_service(db, context.tenant_id)
...
async def list_maintenance_schedules(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les maintenances planifiées"""
    service = get_production_service(db, context.tenant_id)
...
async def list_due_maintenance(
    ...
    """✅ MIGRÉ CORE SaaS: Lister les maintenances dues"""
    service = get_production_service(db, context.tenant_id)
