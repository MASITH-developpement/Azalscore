...
def test_create_store(test_client, mock_saas_context, store_data, sample_store):
...
def test_list_stores(test_client, mock_saas_context, sample_store):
...
def test_list_stores_with_filters(test_client, mock_saas_context, sample_store):
...
def test_get_store(test_client, mock_saas_context, sample_store):
...
def test_get_store_not_found(test_client, mock_saas_context):
...
def test_update_store(test_client, mock_saas_context, sample_store):
...
def test_delete_store(test_client, mock_saas_context):
...
def test_store_pagination(test_client, mock_saas_context, sample_store):
...
def test_create_terminal(test_client, mock_saas_context, terminal_data, sample_terminal):
...
def test_list_terminals(test_client, mock_saas_context, sample_terminal):
...
def test_list_terminals_with_filters(test_client, mock_saas_context, sample_terminal):
...
def test_get_terminal(test_client, mock_saas_context, sample_terminal):
...
def test_get_terminal_not_found(test_client, mock_saas_context):
...
def test_update_terminal(test_client, mock_saas_context, sample_terminal):
...
def test_update_terminal_status(test_client, mock_saas_context, sample_terminal):
...
def test_delete_terminal(test_client, mock_saas_context, sample_terminal):
...
def test_terminal_pagination(test_client, mock_saas_context, sample_terminal):
...
def test_terminal_assignment_to_store(test_client, mock_saas_context, sample_terminal):
...
def test_open_session(test_client, mock_saas_context, session_data, sample_session):
...
def test_open_session_duplicate(test_client, mock_saas_context, session_data):
...
def test_close_session(test_client, mock_saas_context, sample_session):
...
def test_close_session_not_open(test_client, mock_saas_context):
...
def test_list_sessions(test_client, mock_saas_context, sample_session):
...
def test_list_sessions_with_filters(test_client, mock_saas_context, sample_session):
...
def test_get_session(test_client, mock_saas_context, sample_session):
...
def test_get_session_not_found(test_client, mock_saas_context):
...
def test_get_session_dashboard(test_client, mock_saas_context, sample_session):
...
def test_session_pagination(test_client, mock_saas_context, sample_session):
...
def test_create_transaction(test_client, mock_saas_context, transaction_data, sample_transaction):
...
def test_list_transactions(test_client, mock_saas_context, sample_transaction):
...
def test_list_transactions_with_filters(test_client, mock_saas_context, sample_transaction):
...
def test_get_transaction(test_client, mock_saas_context, sample_transaction):
...
def test_get_transaction_not_found(test_client, mock_saas_context):
...
def test_pay_transaction(test_client, mock_saas_context, sample_transaction, payment_data):
...
def test_pay_transaction_partial(test_client, mock_saas_context, sample_transaction):
...
def test_void_transaction(test_client, mock_saas_context, sample_transaction):
...
def test_refund_transaction(test_client, mock_saas_context, sample_transaction):
...
def test_transaction_pagination(test_client, mock_saas_context, sample_transaction):
...
def test_transaction_with_multiple_items(test_client, mock_saas_context, sample_transaction):
...
def test_transaction_with_discount(test_client, mock_saas_context, sample_transaction):
...
def test_create_hold(test_client, mock_saas_context, hold_data, sample_hold):
...
def test_list_hold_transactions(test_client, mock_saas_context, sample_hold):
...
def test_resume_hold_transaction(test_client, mock_saas_context, sample_hold):
...
def test_resume_hold_not_found(test_client, mock_saas_context):
...
def test_delete_hold(test_client, mock_saas_context, sample_hold):
...
def test_hold_pagination(test_client, mock_saas_context, sample_hold):
...
def test_create_cash_movement_in(test_client, mock_saas_context, cash_movement_data, sample_cash_movement):
...
def test_create_cash_movement_out(test_client, mock_saas_context, sample_cash_movement):
...
def test_list_cash_movements(test_client, mock_saas_context, sample_cash_movement):
...
def test_list_cash_movements_with_filters(test_client, mock_saas_context, sample_cash_movement):
...
def test_cash_movement_pagination(test_client, mock_saas_context, sample_cash_movement):
...
def test_cash_movement_balance_tracking(test_client, mock_saas_context, sample_cash_movement):
...
def test_create_quick_key(test_client, mock_saas_context, quick_key_data, sample_quick_key):
...
def test_list_quick_keys(test_client, mock_saas_context, sample_quick_key):
...
def test_list_quick_keys_by_terminal(test_client, mock_saas_context, sample_quick_key):
...
def test_update_quick_key(test_client, mock_saas_context, sample_quick_key):
...
def test_delete_quick_key(test_client, mock_saas_context):
...
def test_quick_key_position_unique(test_client, mock_saas_context, quick_key_data):
...
def test_create_pos_user(test_client, mock_saas_context, user_data, sample_user):
...
def test_list_pos_users(test_client, mock_saas_context, sample_user):
...
def test_login_pos_user(test_client, mock_saas_context, sample_user):
...
def test_login_pos_user_invalid(test_client, mock_saas_context):
...
def test_update_pos_user(test_client, mock_saas_context, sample_user):
...
def test_pos_user_permissions(test_client, mock_saas_context, sample_user):
...
def test_get_daily_report(test_client, mock_saas_context):
...
def test_get_daily_report_specific_date(test_client, mock_saas_context):
...
def test_daily_report_structure(test_client, mock_saas_context):
...
def test_daily_report_calculations(test_client, mock_saas_context):
...
def test_get_dashboard(test_client, mock_saas_context, sample_dashboard):
...
def test_dashboard_structure(test_client, mock_saas_context, sample_dashboard):
...
def test_complete_pos_transaction_flow(test_client, mock_saas_context, sample_session, sample_transaction, sample_user):
...
def test_hold_and_resume_workflow(test_client, mock_saas_context, sample_hold):
