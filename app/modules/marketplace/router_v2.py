"""
AZALS - Module Marketplace - Router v2 - CORE SaaS
==================================================
API pour le site marchand avec provisioning automatique.
"""
...
router = APIRouter(prefix="/v2/marketplace", tags=["Marketplace v2 - CORE SaaS"])
...
async def stripe_webhook(
    ...
    try:
        ...
        webhook = service.process_stripe_webhook(
            event_id, event_type, dict(event), signature
        )
