...
def test_create_project(test_client, client, auth_headers, mock_saas_context, tenant_id, sample_project_data):
...
def test_list_projects(test_client, client, auth_headers, mock_saas_context, tenant_id):
...
def test_list_projects_with_filters(test_client, client, auth_headers, mock_saas_context):
...
def test_list_projects_with_search(test_client, client, auth_headers, mock_saas_context):
...
def test_get_project(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_project(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_delete_project(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_refresh_project_progress(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_get_project_dashboard(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_get_project_stats(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_create_phase(test_client, client, auth_headers, mock_saas_context, sample_project, sample_phase_data):
...
def test_list_phases(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_phase(test_client, client, auth_headers, mock_saas_context, sample_phase):
...
def test_delete_phase(test_client, client, auth_headers, mock_saas_context, sample_phase):
...
def test_create_task(test_client, client, auth_headers, mock_saas_context, sample_project, sample_task_data):
...
def test_list_tasks(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_list_tasks_with_filters(test_client, client, auth_headers, mock_saas_context, sample_project, user_id):
...
def test_list_my_tasks(test_client, client, auth_headers, mock_saas_context, user_id):
...
def test_get_task(test_client, client, auth_headers, mock_saas_context, sample_task):
...
def test_update_task(test_client, client, auth_headers, mock_saas_context, sample_task):
...
def test_delete_task(test_client, client, auth_headers, mock_saas_context, sample_task):
...
def test_create_milestone(test_client, client, auth_headers, mock_saas_context, sample_project, sample_milestone_data):
...
def test_list_milestones(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_milestone(test_client, client, auth_headers, mock_saas_context, sample_milestone):
...
def test_add_team_member(test_client, client, auth_headers, mock_saas_context, sample_project, sample_team_member_data):
...
def test_list_team_members(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_team_member(test_client, client, auth_headers, mock_saas_context, sample_team_member):
...
def test_remove_team_member(test_client, client, auth_headers, mock_saas_context, sample_team_member):
...
def test_create_risk(test_client, client, auth_headers, mock_saas_context, sample_project, sample_risk_data):
...
def test_list_risks(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_list_risks_with_status_filter(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_risk(test_client, client, auth_headers, mock_saas_context, sample_risk):
...
def test_create_issue(test_client, client, auth_headers, mock_saas_context, sample_project, sample_issue_data):
...
def test_list_issues(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_list_issues_with_filters(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_update_issue(test_client, client, auth_headers, mock_saas_context, sample_issue):
...
def test_create_time_entry(test_client, client, auth_headers, mock_saas_context, sample_project, sample_time_entry_data):
...
def test_list_time_entries(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_list_time_entries_with_date_range(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_submit_time_entry(test_client, client, auth_headers, mock_saas_context, sample_time_entry):
...
def test_approve_time_entry(test_client, client, auth_headers, mock_saas_context, sample_time_entry):
...
def test_reject_time_entry(test_client, client, auth_headers, mock_saas_context, sample_time_entry):
...
def test_create_expense(test_client, client, auth_headers, mock_saas_context, sample_project, sample_expense_data):
...
def test_list_expenses(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_list_expenses_with_status_filter(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_approve_expense(test_client, client, auth_headers, mock_saas_context, sample_expense):
...
def test_create_document(test_client, client, auth_headers, mock_saas_context, sample_project, sample_document_data):
...
def test_list_documents(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_create_budget(test_client, client, auth_headers, mock_saas_context, sample_project, sample_budget_data):
...
def test_list_budgets(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_approve_budget(test_client, client, auth_headers, mock_saas_context, sample_budget):
...
def test_create_template(test_client, client, auth_headers, mock_saas_context, sample_template_data):
...
def test_list_templates(test_client, client, auth_headers, mock_saas_context):
...
def test_create_project_from_template(test_client, client, auth_headers, mock_saas_context, sample_template):
...
def test_create_comment(test_client, client, auth_headers, mock_saas_context, sample_project, sample_comment_data):
...
def test_list_comments(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_calculate_project_kpis(test_client, client, auth_headers, mock_saas_context, sample_project):
...
def test_workflow_complete_project_lifecycle(test_client, client, auth_headers, mock_saas_context, sample_project_data):
...
def test_workflow_task_lifecycle(test_client, client, auth_headers, mock_saas_context, sample_project, sample_task_data, user_id):
...
def test_workflow_time_entry_lifecycle(test_client, client, auth_headers, mock_saas_context, sample_project, sample_time_entry_data):
...
def test_workflow_expense_approval(test_client, client, auth_headers, mock_saas_context, sample_project, sample_expense_data):
...
def test_workflow_budget_approval(test_client, client, auth_headers, mock_saas_context, sample_project, sample_budget_data):
...
def test_tenant_isolation_projects(test_client, client, auth_headers, mock_saas_context, tenant_id, sample_project_data):
    ...
    response = test_client.get("/api/v2/projects", headers=auth_headers)
    assert response.status_code == 200
...
def test_tenant_isolation_tasks(test_client, client, auth_headers, mock_saas_context, tenant_id, sample_project, sample_task_data):
...
def test_tenant_isolation_time_entries(test_client, client, auth_headers, mock_saas_context, sample_project, sample_time_entry_data):
...
def test_list_projects_pagination_performance(test_client, client, auth_headers, mock_saas_context, benchmark):
...
def test_list_tasks_pagination_performance(test_client, client, auth_headers, mock_saas_context, sample_project, benchmark):
