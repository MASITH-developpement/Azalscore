"""
AZALS MODULE PROJECTS - Router Unifié
======================================
...
router = APIRouter(prefix="/projects", tags=["Projets - Gestion de Projets"])
...
async def list_projects(
    ...
    return ProjectList(items=projects, total=total, page=page, page_size=page_size)
...
async def list_risks(
    ...
    """Lister les risques d'un projet."""
    service = get_projects_service(db, context.tenant_id, context.user_id)
...
async def list_expenses(
    ...
    """Lister les dépenses d'un projet."""
    service = get_projects_service(db, context.tenant_id, context.user_id)
...
async def list_budgets(
    ...
    """Lister les budgets d'un projet."""
    service = get_projects_service(db, context.tenant_id, context.user_id)
