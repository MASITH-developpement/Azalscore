"""
AZALS - Module Stripe Integration - Router v2 - CORE SaaS
==========================================================
...
router = APIRouter(prefix="/v2/stripe", tags=["Stripe Integration v2 - CORE SaaS"])
...
async def get_dashboard(
    ...
    return StripeDashboard(
        ...
        refunds_count=0,  # Simplified
        disputes_count=0,  # Simplified
    )
