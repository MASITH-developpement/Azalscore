"""
AZALS MODULE T4 - Router API Contrôle Qualité v2 - CORE SaaS
==============================================================
...
router = APIRouter(prefix="/v2/qc", tags=["Quality Control v2 - CORE SaaS"])
...
def get_qc_service(
    ...
    """Factory pour obtenir une instance du service QC v2."""
