...
def test_get_config(client, auth_headers, sample_guardian_config):
...
def test_update_config(client, admin_auth_headers, sample_guardian_config):
...
def test_update_config_insufficient_permissions(client, auth_headers):
...
def test_report_error(client, auth_headers, tenant_id):
...
def test_report_frontend_error(client, auth_headers, tenant_id):
...
def test_list_errors(client, auth_headers, sample_error):
...
def test_get_error(client, auth_headers, sample_error):
...
def test_acknowledge_error(client, auth_headers, sample_error):
...
def test_errors_tenant_isolation(client, auth_headers, db_session, tenant_id):
...
def test_create_correction(client, auth_headers, sample_error, tenant_id):
...
def test_list_corrections(client, auth_headers, sample_correction):
...
def test_list_pending_validations(client, auth_headers, db_session, sample_error, tenant_id):
...
def test_get_correction(client, auth_headers, sample_correction):
...
def test_validate_correction(client, admin_auth_headers, sample_correction_pending):
...
def test_validate_correction_insufficient_permissions(client, auth_headers, sample_correction_pending):
...
def test_rollback_correction(client, admin_auth_headers, sample_correction):
...
def test_get_correction_tests(client, auth_headers, sample_correction):
...
def test_create_correction_rule(client, admin_auth_headers, tenant_id):
...
def test_create_rule_insufficient_permissions(client, auth_headers):
...
def test_list_correction_rules(client, auth_headers, sample_correction_rule):
...
def test_get_correction_rule(client, auth_headers, sample_correction_rule):
...
def test_update_correction_rule(client, admin_auth_headers, sample_correction_rule):
...
def test_correction_rules_tenant_isolation(client, auth_headers, db_session):
...
def test_get_alert(client, auth_headers, sample_alert):
...
def test_acknowledge_alert(client, auth_headers, sample_alert):
...
def test_alert_workflow(client, auth_headers, db_session, tenant_id):
...
def test_alerts_tenant_isolation(client, auth_headers, db_session):
...
def test_get_statistics(client, auth_headers, sample_error, sample_correction):
...
def test_get_dashboard(client, auth_headers, sample_error, sample_alert):
...
def test_audit_trail_automatic(client, auth_headers, sample_error):
...
def test_role_based_access_control(client, auth_headers, admin_auth_headers):
