...
@pytest.fixture
def mock_ai_service(monkeypatch, tenant_id, user_id):
    ...
    monkeypatch.setattr(router_v2, "get_ai_service", mock_get_service)
    return MockAIService(None, tenant_id, user_id)
