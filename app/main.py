...
# NOTE: Les routes /health et /metrics sont définies dans health_router et metrics_router
# Ne pas définir de routes fallback ici pour éviter les conflits de routes
# qui causent l'erreur "No response returned"
