...
class TestSignupService:
    ...
    def test_signup_creates_admin_user(self, db, sample_tenant_data):
        ...
        # Note: role is stored as UserRole enum, compare with string value
        assert str(user.role.value) == "ADMIN" or str(user.role) == "UserRole.ADMIN"
    ...
    def test_signup_creates_onboarding(self, db, sample_tenant_data):
        ...
        assert onboarding.admin_created == True
