...
class TestWorkflowStatuts:
    ...
    def test_statut_initial_a_planifier(self, service, intervention_base):
        """Le statut initial doit être A_PLANIFIER."""
        intervention = service.create_intervention(intervention_base)
    ...
    def test_workflow_complet(
        ...
        """Test du workflow complet: A_PLANIFIER -> PLANIFIEE -> EN_COURS -> TERMINEE."""
        # Création
        intervention = service.create_intervention(intervention_base)
        assert intervention.statut == InterventionStatut.A_PLANIFIER
...
class TestRefusActionsInvalides:
    ...
    def test_arrivee_sans_planification_refuse(self, service, intervention_base):
        """Impossible d'arriver sur site sans planification."""
        intervention = service.create_intervention(intervention_base)
...
class TestCalculDureeAutomatique:
    ...
    def test_duree_basee_sur_demarrage_et_fin(
        self, service, test_db, intervention_base, intervenant_id
    ):
...
class TestRapportFinal:
    ...
    def test_rapport_final_reference_format(
        ...
        assert rapport_final.reference.startswith("RFINAL-")
...
class TestStatistiques:
    ...
    def test_stats_comptent_correctement(
        ...
        int1 = service.create_intervention(intervention_base)  # A_PLANIFIER
