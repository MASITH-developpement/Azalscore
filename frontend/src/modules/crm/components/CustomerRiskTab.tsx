/**
 * AZALSCORE Module - CRM - Risk Tab
 * Onglet Analyse de Risque pour le client
 *
...
/**
 * CustomerRiskTab - Onglet Analyse de Risque
 */
export const CustomerRiskTab: React.FC<TabContentProps<Customer>> = ({ data: customer }) => {
  const [showDetails, setShowDetails] = useState(true);

  // Recuperer SIREN ou SIRET du client
  const identifier = customer.registration_number || customer.tax_id || '';
      ...
      <div className="azals-std-tab-content">
        <Card className="text-center py-8">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            Pour analyser le risque de ce client, veuillez d'abord renseigner
...
export default CustomerRiskTab;
