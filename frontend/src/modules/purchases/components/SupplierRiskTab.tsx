/**
 * AZALSCORE Module - Purchases - Supplier Risk Tab
 * Onglet Analyse de Risque pour le fournisseur
 *
...
/**
 * SupplierRiskTab - Onglet Analyse de Risque
 */
export const SupplierRiskTab: React.FC<TabContentProps<Supplier>> = ({ data: supplier }) => {
  const [showDetails, setShowDetails] = useState(true);

  // Recuperer SIREN ou SIRET du fournisseur
  const identifier = supplier.tax_id || '';
      ...
      <div className="azals-std-tab-content">
        <Card className="text-center py-8">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            Pour analyser le risque de ce fournisseur, veuillez d'abord renseigner
            son numero SIREN (9 chiffres) ou SIRET (14 chiffres) dans le champ N° TVA/SIRET.
          </p>
        </Card>
      </div>
    );
...
export default SupplierRiskTab;
