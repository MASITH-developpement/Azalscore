...
export const useValiderIntervention = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return api.post(`/v2/interventions/${id}/valider`, {});
    },
    onSuccess: () => {
...
export const useDemarrerIntervention = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return api.post(`/v2/interventions/${id}/arrivee`, {});
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['interventions'] });
    },
...
export const useTerminerIntervention = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return api.post(`/v2/interventions/${id}/terminer`, {});
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['interventions'] });
    },
...
export const useBloquerIntervention = () => {
  ...
  return useMutation({
    mutationFn: async ({ id, motif }: { id: string; motif: string }) => {
      return api.post(`/v2/interventions/${id}/bloquer`, { motif });
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['interventions'] });
    },
...
export const useDebloquerIntervention = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return api.post(`/v2/interventions/${id}/debloquer`, {});
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['interventions'] });
    },
...
export const useAnnulerIntervention = () => {
  ...
  return useMutation({
    mutationFn: async (id: string) => {
      return api.post(`/v2/interventions/${id}/annuler`, {});
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['interventions'] });
    },
