  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { id: 'quotes', label: 'Devis', path: '/documents?type=QUOTE&mode=list' },
          { id: 'invoices', label: 'Factures', path: '/documents?type=INVOICE&mode=list' },
          { id: 'credits', label: 'Avoirs', path: '/documents?type=CREDIT_NOTE&mode=list' },
          { id: 'orders', label: 'Commandes', path: '/documents?type=ORDER&mode=list' },
          { id: 'purchase-orders', label: 'Commandes fournisseurs', path: '/documents?type=PURCHASE_ORDER&mode=list', capability: 'purchases.view' },
          { id: 'purchase-invoices', label: 'Factures fournisseurs', path: '/documents?type=PURCHASE_INVOICE&mode=list', capability: 'purchases.view' },
        ],
      },
    ],
  },
