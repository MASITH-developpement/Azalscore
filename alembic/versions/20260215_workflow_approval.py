...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('DRAFT', 'PENDING', 'IN_PROGRESS', 'APPROVED', 'REJECTED', 'CANCELLED', 'EXPIRED', name='workflow_status', create_type=False), default='PENDING', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('DRAFT', 'PENDING', 'IN_PROGRESS', 'APPROVED', 'REJECTED', 'CANCELLED', 'EXPIRED', name='workflow_status', create_type=False), default='PENDING', nullable=False),
        sa.Column('action_taken', postgresql.ENUM('APPROVE', 'REJECT', 'DELEGATE', 'ESCALATE', 'REQUEST_INFO', name='approval_action', create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('notification_type', postgresql.ENUM('PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'ESCALATED', 'REMINDER', 'EXPIRED', name='notification_type', create_type=False), nullable=False),
