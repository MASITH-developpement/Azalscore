...
down_revision: Union[str, None] = 'enums_create_all'
...
def upgrade() -> None:
    # ==============================================================================
    # MIGRATION IDEMPOTENTE - SAFE POUR PRODUCTION / CI / REJEU
    # Toutes les créations de tables sont protégées par inspector.has_table()
    # Les ENUMs utilisent create_type=False pour éviter DuplicateObject
    # ==============================================================================
    bind = op.get_bind()
    ...
    if not inspector.has_table("accounting_bank_connections"):
        op.create_table(
            ...
            sa.UniqueConstraint('tenant_id', 'provider', 'connection_id', name='uq_bankconn_provider')
        )
        op.create_index('idx_bankconn_tenant', 'accounting_bank_connections', ['tenant_id'], unique=False)
        op.create_index('idx_bankconn_tenant_status', 'accounting_bank_connections', ['tenant_id', 'status'], unique=False)
    ...
    # --- accounting_email_inboxes ---
    if not inspector.has_table("accounting_email_inboxes"):
    ...
    if not inspector.has_table("accounting_reconciliation_rules"):
    ...
    if not inspector.has_table("accounting_tax_configurations"):
    ...
    # --- accounting_universal_chart ---
    if not inspector.has_table("accounting_universal_chart"):
    ...
    # --- accounting_user_preferences ---
    if not inspector.has_table("accounting_user_preferences"):
    ...
    # --- cash_forecasts ---
    if not inspector.has_table("cash_forecasts"):
    ...
    # --- compliance_policies ---
    if not inspector.has_table("compliance_policies"):
    ...
    if not inspector.has_table("compliance_regulations"):
    ...
    # --- compliance_reports ---
    if not inspector.has_table("compliance_reports"):
    ...
    # --- core_audit_journal ---
    if not inspector.has_table("core_audit_journal"):
    ...
    if not inspector.has_table("inventory_warehouses"):
    ...
    # --- maintenance_assets ---
    if not inspector.has_table("maintenance_assets"):
    ...
    if not inspector.has_table("maintenance_contracts"):
    ...
    # --- production_plans ---
    if not inspector.has_table("production_plans"):
    ...
    # --- production_routings ---
    if not inspector.has_table("production_routings"):
    ...
    if not inspector.has_table("production_work_centers"):
    ...
    # --- red_decision_reports ---
    if not inspector.has_table("red_decision_reports"):
    ...
    # --- red_decision_workflows ---
    if not inspector.has_table("red_decision_workflows"):
    ...
    # --- tenant_events ---
    if not inspector.has_table("tenant_events"):
    ...
    # --- tenant_modules ---
    if not inspector.has_table("tenant_modules"):
    ...
    # --- tenant_onboarding ---
    if not inspector.has_table("tenant_onboarding"):
    ...
    # --- treasury_forecasts ---
    if not inspector.has_table("treasury_forecasts"):
    ...
    # --- accounting_bank_sync_sessions ---
    if not inspector.has_table("accounting_bank_sync_sessions"):
    ...
    # --- accounting_chart_mappings ---
    if not inspector.has_table("accounting_chart_mappings"):
    ...
    # --- accounting_email_processing_logs ---
    if not inspector.has_table("accounting_email_processing_logs"):
    ...
    if not inspector.has_table("cash_flow_categories"):
    ...
    # --- compliance_audits ---
    if not inspector.has_table("compliance_audits"):
    ...
    if not inspector.has_table("compliance_incidents"):
    ...
    if not inspector.has_table("compliance_policy_acknowledgments"):
    ...
    # --- compliance_risks ---
    if not inspector.has_table("compliance_risks"):
    ...
    if not inspector.has_table("compliance_trainings"):
    ...
    # --- fiscal_periods ---
    if not inspector.has_table("fiscal_periods"):
    ...
    # --- inventory_locations ---
    if not inspector.has_table("inventory_locations"):
    ...
    # --- inventory_pickings ---
    if not inspector.has_table("inventory_pickings"):
    ...
    if not inspector.has_table("inventory_valuations"):
    ...
    if not inspector.has_table("maintenance_asset_documents"):
    ...
    if not inspector.has_table("maintenance_asset_meters"):
    ...
    # --- maintenance_kpis ---
    if not inspector.has_table("maintenance_kpis"):
    ...
    # --- production_bom ---
    if not inspector.has_table("production_bom"):
    ...
    # --- production_maintenance_schedules ---
    if not inspector.has_table("production_maintenance_schedules"):
    ...
    if not inspector.has_table("production_routing_operations"):
    ...
    # --- production_wc_capacity ---
    if not inspector.has_table("production_wc_capacity"):
    ...
    if not inspector.has_table("compliance_audit_findings"):
    ...
    # --- compliance_gaps ---
    if not inspector.has_table("compliance_gaps"):
    ...
    if not inspector.has_table("compliance_training_completions"):
    ...
    # --- financial_reports ---
    if not inspector.has_table("financial_reports"):
    ...
    # --- inventory_counts ---
    if not inspector.has_table("inventory_counts"):
    ...
    # --- inventory_products ---
    if not inspector.has_table("inventory_products"):
    ...
    if not inspector.has_table("maintenance_meter_readings"):
    ...
    # --- maintenance_plans ---
    if not inspector.has_table("maintenance_plans"):
    ...
    if not inspector.has_table("production_bom_lines"):
    ...
    # --- production_manufacturing_orders ---
    if not inspector.has_table("production_manufacturing_orders"):
    ...
    if not inspector.has_table("accounting_documents"):
    ...
    # --- accounting_synced_bank_accounts ---
    if not inspector.has_table("accounting_synced_bank_accounts"):
    ...
    # --- compliance_actions ---
    if not inspector.has_table("compliance_actions"):
    ...
    if not inspector.has_table("inventory_replenishment_rules"):
    ...
    if not inspector.has_table("inventory_stock_levels"):
    ...
    # --- journal_entry_lines ---
    if not inspector.has_table("journal_entry_lines"):
    ...
    if not inspector.has_table("maintenance_plan_tasks"):
    ...
    if not inspector.has_table("maintenance_spare_parts"):
    ...
    if not inspector.has_table("production_plan_lines"):
    ...
    if not inspector.has_table("production_work_orders"):
    ...
    # --- accounting_ai_classifications ---
    if not inspector.has_table("accounting_ai_classifications"):
    ...
    # --- accounting_alerts ---
    if not inspector.has_table("accounting_alerts"):
    ...
    if not inspector.has_table("accounting_auto_entries"):
    ...
    if not inspector.has_table("accounting_ocr_results"):
    ...
    if not inspector.has_table("accounting_synced_transactions"):
    ...
    if not inspector.has_table("inventory_count_lines"):
    ...
    if not inspector.has_table("inventory_serial_numbers"):
    ...
    if not inspector.has_table("maintenance_asset_components"):
    ...
    if not inspector.has_table("maintenance_spare_part_stock"):
    ...
    if not inspector.has_table("production_material_consumptions"):
    ...
    # --- production_outputs ---
    if not inspector.has_table("production_outputs"):
    ...
    # --- production_scraps ---
    if not inspector.has_table("production_scraps"):
    ...
    # --- production_wo_time_entries ---
    if not inspector.has_table("production_wo_time_entries"):
    ...
    # --- accounting_reconciliation_history ---
    if not inspector.has_table("accounting_reconciliation_history"):
    ...
    if not inspector.has_table("inventory_movement_lines"):
    ...
    if not inspector.has_table("inventory_picking_lines"):
    ...
    if not inspector.has_table("maintenance_failures"):
    ...
    if not inspector.has_table("maintenance_failure_causes"):
    ...
    if not inspector.has_table("maintenance_work_orders"):
    ...
    if not inspector.has_table("maintenance_part_requests"):
    ...
    if not inspector.has_table("maintenance_wo_labor"):
    ...
    if not inspector.has_table("maintenance_wo_parts"):
    ...
    if not inspector.has_table("maintenance_wo_tasks"):
    ...
    # --- qc_metrics ---
    if not inspector.has_table("qc_metrics"):
    ...
    # --- qc_templates ---
    if not inspector.has_table("qc_templates"):
    ...
    # --- qc_test_runs ---
    if not inspector.has_table("qc_test_runs"):
    ...
    # --- qc_rules ---
    if not inspector.has_table("qc_rules"):
    ...
    # --- qc_validations ---
    if not inspector.has_table("qc_validations"):
    ...
    # --- qc_alerts ---
    if not inspector.has_table("qc_alerts"):
    ...
    # --- qc_dashboards ---
    if not inspector.has_table("qc_dashboards"):
    ...
    # --- qc_module_registry ---
    if not inspector.has_table("qc_module_registry"):
    ...
    # --- qc_check_results ---
    if not inspector.has_table("qc_check_results"):
...
def downgrade() -> None:
    # ==============================================================================
    # DOWNGRADE IDEMPOTENT - Vérifie l'existence avant de dropper
    # ==============================================================================
    bind = op.get_bind()
    inspector = inspect(bind)

    if inspector.has_table("qc_check_results"):
        op.drop_table("qc_check_results")
    if inspector.has_table("qc_module_registry"):
        op.drop_table("qc_module_registry")
    if inspector.has_table("qc_dashboards"):
        op.drop_table("qc_dashboards")
    if inspector.has_table("qc_alerts"):
        op.drop_table("qc_alerts")
    if inspector.has_table("qc_validations"):
        op.drop_table("qc_validations")
    if inspector.has_table("system_settings"):
        op.drop_table("system_settings")
    if inspector.has_table("qc_rules"):
        op.drop_table("qc_rules")
    if inspector.has_table("qc_test_runs"):
        op.drop_table("qc_test_runs")
    if inspector.has_table("qc_templates"):
        op.drop_table("qc_templates")
    if inspector.has_table("qc_metrics"):
        op.drop_table("qc_metrics")
    if inspector.has_table("maintenance_wo_tasks"):
        op.drop_table("maintenance_wo_tasks")
    if inspector.has_table("maintenance_wo_parts"):
        op.drop_table("maintenance_wo_parts")
    if inspector.has_table("maintenance_wo_labor"):
        op.drop_table("maintenance_wo_labor")
    if inspector.has_table("maintenance_part_requests"):
        op.drop_table("maintenance_part_requests")
    if inspector.has_table("maintenance_work_orders"):
        op.drop_table("maintenance_work_orders")
    if inspector.has_table("maintenance_failure_causes"):
        op.drop_table("maintenance_failure_causes")
    if inspector.has_table("maintenance_failures"):
        op.drop_table("maintenance_failures")
    if inspector.has_table("inventory_picking_lines"):
        op.drop_table("inventory_picking_lines")
    if inspector.has_table("inventory_movement_lines"):
        op.drop_table("inventory_movement_lines")
    if inspector.has_table("accounting_reconciliation_history"):
        op.drop_table("accounting_reconciliation_history")
    if inspector.has_table("production_wo_time_entries"):
        op.drop_table("production_wo_time_entries")
    if inspector.has_table("production_scraps"):
        op.drop_table("production_scraps")
    if inspector.has_table("production_outputs"):
        op.drop_table("production_outputs")
    if inspector.has_table("production_material_consumptions"):
        op.drop_table("production_material_consumptions")
    if inspector.has_table("maintenance_spare_part_stock"):
        op.drop_table("maintenance_spare_part_stock")
    if inspector.has_table("maintenance_asset_components"):
        op.drop_table("maintenance_asset_components")
    if inspector.has_table("inventory_serial_numbers"):
        op.drop_table("inventory_serial_numbers")
    if inspector.has_table("inventory_count_lines"):
        op.drop_table("inventory_count_lines")
    if inspector.has_table("bank_transactions"):
        op.drop_table("bank_transactions")
    if inspector.has_table("bank_statement_lines"):
        op.drop_table("bank_statement_lines")
    if inspector.has_table("accounting_synced_transactions"):
        op.drop_table("accounting_synced_transactions")
    if inspector.has_table("accounting_ocr_results"):
        op.drop_table("accounting_ocr_results")
    if inspector.has_table("accounting_auto_entries"):
        op.drop_table("accounting_auto_entries")
    if inspector.has_table("accounting_alerts"):
        op.drop_table("accounting_alerts")
    if inspector.has_table("accounting_ai_classifications"):
        op.drop_table("accounting_ai_classifications")
    if inspector.has_table("production_work_orders"):
        op.drop_table("production_work_orders")
    if inspector.has_table("production_plan_lines"):
        op.drop_table("production_plan_lines")
    if inspector.has_table("maintenance_spare_parts"):
        op.drop_table("maintenance_spare_parts")
    if inspector.has_table("maintenance_plan_tasks"):
        op.drop_table("maintenance_plan_tasks")
    if inspector.has_table("journal_entry_lines"):
        op.drop_table("journal_entry_lines")
    if inspector.has_table("inventory_stock_levels"):
        op.drop_table("inventory_stock_levels")
    if inspector.has_table("inventory_replenishment_rules"):
        op.drop_table("inventory_replenishment_rules")
    if inspector.has_table("inventory_lots"):
        op.drop_table("inventory_lots")
    if inspector.has_table("compliance_actions"):
        op.drop_table("compliance_actions")
    if inspector.has_table("bank_statements"):
        op.drop_table("bank_statements")
    if inspector.has_table("accounting_synced_bank_accounts"):
        op.drop_table("accounting_synced_bank_accounts")
    if inspector.has_table("accounting_documents"):
        op.drop_table("accounting_documents")
    if inspector.has_table("production_manufacturing_orders"):
        op.drop_table("production_manufacturing_orders")
    if inspector.has_table("production_bom_lines"):
        op.drop_table("production_bom_lines")
    if inspector.has_table("maintenance_plans"):
        op.drop_table("maintenance_plans")
    if inspector.has_table("maintenance_meter_readings"):
        op.drop_table("maintenance_meter_readings")
    if inspector.has_table("journal_entries"):
        op.drop_table("journal_entries")
    if inspector.has_table("inventory_products"):
        op.drop_table("inventory_products")
    if inspector.has_table("inventory_movements"):
        op.drop_table("inventory_movements")
    if inspector.has_table("inventory_counts"):
        op.drop_table("inventory_counts")
    if inspector.has_table("financial_reports"):
        op.drop_table("financial_reports")
    if inspector.has_table("compliance_training_completions"):
        op.drop_table("compliance_training_completions")
    if inspector.has_table("compliance_gaps"):
        op.drop_table("compliance_gaps")
    if inspector.has_table("compliance_audit_findings"):
        op.drop_table("compliance_audit_findings")
    if inspector.has_table("bank_accounts"):
        op.drop_table("bank_accounts")
    if inspector.has_table("production_wc_capacity"):
        op.drop_table("production_wc_capacity")
    if inspector.has_table("production_routing_operations"):
        op.drop_table("production_routing_operations")
    if inspector.has_table("production_maintenance_schedules"):
        op.drop_table("production_maintenance_schedules")
    if inspector.has_table("production_bom"):
        op.drop_table("production_bom")
    if inspector.has_table("maintenance_kpis"):
        op.drop_table("maintenance_kpis")
    if inspector.has_table("maintenance_asset_meters"):
        op.drop_table("maintenance_asset_meters")
    if inspector.has_table("maintenance_asset_documents"):
        op.drop_table("maintenance_asset_documents")
    if inspector.has_table("journals"):
        op.drop_table("journals")
    if inspector.has_table("inventory_valuations"):
        op.drop_table("inventory_valuations")
    if inspector.has_table("inventory_pickings"):
        op.drop_table("inventory_pickings")
    if inspector.has_table("inventory_locations"):
        op.drop_table("inventory_locations")
    if inspector.has_table("fiscal_periods"):
        op.drop_table("fiscal_periods")
    if inspector.has_table("compliance_trainings"):
        op.drop_table("compliance_trainings")
    if inspector.has_table("compliance_risks"):
        op.drop_table("compliance_risks")
    if inspector.has_table("compliance_requirements"):
        op.drop_table("compliance_requirements")
    if inspector.has_table("compliance_policy_acknowledgments"):
        op.drop_table("compliance_policy_acknowledgments")
    if inspector.has_table("compliance_incidents"):
        op.drop_table("compliance_incidents")
    if inspector.has_table("compliance_documents"):
        op.drop_table("compliance_documents")
    if inspector.has_table("compliance_audits"):
        op.drop_table("compliance_audits")
    if inspector.has_table("compliance_assessments"):
        op.drop_table("compliance_assessments")
    if inspector.has_table("cash_flow_categories"):
        op.drop_table("cash_flow_categories")
    if inspector.has_table("accounting_email_processing_logs"):
        op.drop_table("accounting_email_processing_logs")
    if inspector.has_table("accounting_chart_mappings"):
        op.drop_table("accounting_chart_mappings")
    if inspector.has_table("accounting_bank_sync_sessions"):
        op.drop_table("accounting_bank_sync_sessions")
    if inspector.has_table("users"):
        op.drop_table("users")
    if inspector.has_table("treasury_forecasts"):
        op.drop_table("treasury_forecasts")
    if inspector.has_table("tenants"):
        op.drop_table("tenants")
    if inspector.has_table("tenant_usage"):
        op.drop_table("tenant_usage")
    if inspector.has_table("tenant_subscriptions"):
        op.drop_table("tenant_subscriptions")
    if inspector.has_table("tenant_settings"):
        op.drop_table("tenant_settings")
    if inspector.has_table("tenant_onboarding"):
        op.drop_table("tenant_onboarding")
    if inspector.has_table("tenant_modules"):
        op.drop_table("tenant_modules")
    if inspector.has_table("tenant_invitations"):
        op.drop_table("tenant_invitations")
    if inspector.has_table("tenant_events"):
        op.drop_table("tenant_events")
    if inspector.has_table("red_decision_workflows"):
        op.drop_table("red_decision_workflows")
    if inspector.has_table("red_decision_reports"):
        op.drop_table("red_decision_reports")
    if inspector.has_table("production_work_centers"):
        op.drop_table("production_work_centers")
    if inspector.has_table("production_routings"):
        op.drop_table("production_routings")
    if inspector.has_table("production_plans"):
        op.drop_table("production_plans")
    if inspector.has_table("maintenance_contracts"):
        op.drop_table("maintenance_contracts")
    if inspector.has_table("maintenance_assets"):
        op.drop_table("maintenance_assets")
    if inspector.has_table("items"):
        op.drop_table("items")
    if inspector.has_table("inventory_warehouses"):
        op.drop_table("inventory_warehouses")
    if inspector.has_table("inventory_categories"):
        op.drop_table("inventory_categories")
    if inspector.has_table("fiscal_years"):
        op.drop_table("fiscal_years")
    if inspector.has_table("decisions"):
        op.drop_table("decisions")
    if inspector.has_table("core_audit_journal"):
        op.drop_table("core_audit_journal")
    if inspector.has_table("compliance_reports"):
        op.drop_table("compliance_reports")
    if inspector.has_table("compliance_regulations"):
        op.drop_table("compliance_regulations")
    if inspector.has_table("compliance_policies"):
        op.drop_table("compliance_policies")
    if inspector.has_table("cash_forecasts"):
        op.drop_table("cash_forecasts")
    if inspector.has_table("accounts"):
        op.drop_table("accounts")
    if inspector.has_table("accounting_user_preferences"):
        op.drop_table("accounting_user_preferences")
    if inspector.has_table("accounting_universal_chart"):
        op.drop_table("accounting_universal_chart")
    if inspector.has_table("accounting_tax_configurations"):
        op.drop_table("accounting_tax_configurations")
    if inspector.has_table("accounting_reconciliation_rules"):
        op.drop_table("accounting_reconciliation_rules")
    if inspector.has_table("accounting_email_inboxes"):
        op.drop_table("accounting_email_inboxes")
    if inspector.has_table("accounting_dashboard_metrics"):
        op.drop_table("accounting_dashboard_metrics")
    if inspector.has_table("accounting_bank_connections"):
