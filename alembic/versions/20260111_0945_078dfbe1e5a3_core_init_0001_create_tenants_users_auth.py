...
def upgrade() -> None:
    ...
    op.create_table('accounting_bank_connections',
    ...
    op.create_index(op.f('ix_accounting_bank_connections_tenant_id'), 'accounting_bank_connections', ['tenant_id'], unique=False)
